...
\begin{frame}[plain,c]{The two studies in my thesis}{}
	...
	\column{0.5\textwidth}
		...
		\begin{block}{\color<4->{gray} Geomagnetic impact of the solar wind} \color<4->{gray}
			\action<2->{
	...
	\column{0.5\textwidth}
		...
		\begin{block}{Empirical solar wind model}
			\action<3->{
...
\begin{frame}[plain,c]{Solar wind}{}
	...
	\column{0.5\textwidth}
		...
		\begin{itemize}
			...
			\item In-situ measurements confirmed its existence in 1959
			\item Spacecraft monitored it continuously near Earth since
		\end{itemize}
		\vspace{4mm}
		\action<2->{Solar wind was measured in-situ throughout the heliosphere:
		\begin{itemize}
...
% 		\includegraphics<.>[width=\textwidth]{../talk_figures/helios_ulysses_voyager/helios_ulysses_voyager.pdf}
		...
		\action<5->{
			...
			\begin{itemize}
				\item slow wind streams
				\item fast wind streams
				\item coronal mass ejections
			\end{itemize}
			\action<6->{$\Rightarrow$ Their share varies with solar activity}
		}
...
\begin{frame}[plain,c]{Solar wind}{}
	...
	\column{0.4\textwidth}
		...
		\end{itemize}
		\vspace{10mm}
		\action<2->{The Parker Solar Probe mission is to fly within 10\,\Rs{} of the Sun \citep{Fox2015}}
	\end{columns}
\end{frame}
...
\begin{frame}[plain,t]{Solar activity dependence -- OMNI data}{}
	...
	\captionoftiny{figure}{\centering Credit: \citet{Venzmer2018}}
\end{frame}
\begin{frame}[plain,t]{Solar distance dependence -- Helios data}{}
	\centering
...
\end{frame}
\begin{frame}[plain,c,label=wavelengths]{Solar surface and atmosphere}{}
	\begin{columns}[c]
...
\begin{frame}[plain,c]{Parker Solar Probe}{}
	...
	\end{columns}
\end{frame}
\begin{frame}[plain,c,label=psp_dist_ssn]{PSP distance and solar activity}{}
	\begin{columns}[c]
	\column{0.7\textwidth}
...
\begin{frame}[plain,c,label=time_lag]{Solar activity dependence -- OMNI data}{}
	\begin{columns}[c]
	\column{0.5\textwidth}
