...
% \date{\today}
\date[2018]{\vspace*{0.4cm}\\ Thursday, 1 November 2018, 14:00\\Seminarraum Astrophysik (SR 17, F 05.104)\\}
\subject{Solar wind}
...
\begin{frame}[plain,c]{Solar wind}{}
	...
	\column{0.5\textwidth}
		...
		\hspace*{-20pt}
		\includegraphics<2>[width=1.1\textwidth]{../talk_figures/timeline_SSN_with_data_and_sc_wosc.pdf}
		\includegraphics<3->[width=1.1\textwidth]{../talk_figures/timeline_SSN_with_data_and_sc.pdf}
...
\begin{frame}[plain,c]{Parker Solar Probe}{}
	...
	\column{0.5\textwidth}
		...
		\centering
		\includegraphics[width=0.8\textwidth]{../figures_of_others/images/PSP_fencap2.jpg}
...
\begin{frame}[plain,c]{PSP distance and SSN prediction}{}
	\begin{columns}[c]
	\column{0.7\textwidth}
...
\begin{frame}[plain,c]{Solar activity}{}
	...
	\column{0.3\textwidth}
		...
		\includegraphics[width=0.95\textwidth]{../talk_figures/20130102_234500_1024_HMIIC.jpg}
		\captionoftiny{figure}{Credit: \href{https://sdo.gsfc.nasa.gov/data/}{NASA SDO/HMI}, 1 January 2013}
		\includegraphics[width=0.95\textwidth]{../talk_figures/latest_2048_HMIIC.jpg}
		\captionoftiny{figure}{Credit: \href{https://sdo.gsfc.nasa.gov/data/}{NASA SDO/HMI}, 26 October 2018}
...
\begin{frame}[plain,c]{Solar activity}{}
	...
	\column{0.5\textwidth}
		...
		\includegraphics<2->[width=\textwidth]{../talk_figures/SW_SSN_correlation_plot.png}
		
		\includegraphics<3>[width=\textwidth]{../figures_paper/OMNI_yearly_BVNTvsSSN_a.pdf}
...
\end{frame}
\begin{frame}[plain,c]{Helios data}{}
	\begin{columns}[c]
	\column{0.5\textwidth}
	...
	\end{columns}
\end{frame}
\begin{frame}[plain,c]{Solar distance}{}
	\centering
...
\begin{frame}[plain,c]{Sun--Earth evolution of the solar wind}{Aims}
